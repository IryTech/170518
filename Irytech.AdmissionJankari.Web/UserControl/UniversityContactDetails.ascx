<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UniversityContactDetails.ascx.cs" Inherits="IryTech.AdmissionJankari20.Web.UserControl.UniversityContactDetails" %>
